...
export const ui = {
  nl: {
    ...
    "route.process": "/werkwijze",
    "route.cases": "/realisaties",
  ...
  fr: {
    ...
    "route.process": "/fr/notre-approche",
    "route.cases": "/fr/realisations",
...
export function getAlternateLanguagePath(currentPath: string, currentLang: Lang): string {
  ...
  const pathMap: Record<string, Record<Lang, string>> = {
    ...
    "/werkwijze": { nl: "/werkwijze", fr: "/fr/notre-approche" },
    "/realisaties": { nl: "/realisaties", fr: "/fr/realisations" },
